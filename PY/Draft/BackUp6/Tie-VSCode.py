...
vCover = clear_cover+horizontal_diameter+(vertical_diameter/2)
hCover = clear_cover+(horizontal_diameter/2)
asp = (bLen-(2*vCover))/float(len(bRange)-1)
basePoint = geometry.Point(0, 0, 0)

vAttribute = {
    'basePoint': basePoint, 'clearCover': clear_cover, 'vCover': vCover,
