...
""" Basic Geometries """
# Get Coordinates of Points List for plotting preparation (SHAPELY) depending on point/curve criteria
def gc_curve(x):
	temp = []
	for i in x:
		temp.append((i.x, i.y))
...
""" Basic Preparation """
# Slicing b_Side vertical rebar list into a pattern depending on spacing criteria
